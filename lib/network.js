...
async function fetchCanWrite(url) {
  const result = await fetchGraphql('repl', `
...
async function createFolder(name, parentId = '') {
  await fetchGraphql('createReplFolder', `
...
async function deleteFolder(id) {
  await fetchGraphql('deleteReplFolder', `
...
export {
  fetchRepls, fetchFolders, fetchFiles, fetchCanWrite,
  logIn, signUp, logOut, isLoggedIn,
  getUrls, readFile, isFileBinary, writeFile, deleteFile,
  createRepl, deleteRepl, forkRepl,
  createFolder, deleteFolder,
  fetchLanguages, getWebUrl
}